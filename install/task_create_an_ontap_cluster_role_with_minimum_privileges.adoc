...
summary: 'Vous devez créer un rôle de cluster ONTAP avec des privilèges minimaux afin de ne pas avoir à utiliser le rôle d"administrateur ONTAP pour effectuer des opérations dans SnapCenter.' 
---
