...
summary: 'Vous devez importer les certificats d"autorité de certification sur le serveur SnapCenter et les plug-ins hôtes Windows à l"aide de la console de gestion Microsoft (MMC).' 
---
