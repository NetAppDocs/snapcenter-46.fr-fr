...
summary: 'Il faut créer des rôles SVM si vous configurez des SVM dans ONTAP pour qu"ils puissent être utilisés avec SanpCenter et ne pas utiliser le rôle vsadmin.' 
---
