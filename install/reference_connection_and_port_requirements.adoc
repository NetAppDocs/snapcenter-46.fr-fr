...
|===
Pour modifier les détails du port, voir https://docs.netapp.com/us-en/snapcenter/admin/concept_manage_hosts.html#modify-plug-in-hosts[] [Modifier les hôtes du plug-in^].
