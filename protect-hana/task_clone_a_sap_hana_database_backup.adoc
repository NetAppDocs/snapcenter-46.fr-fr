...
*À propos de cette tâche* pour plus d'informations sur les limites des opérations de fractionnement de clone, voir http://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-vsmg/home.html["Guide de gestion du stockage logique ONTAP 9"^].
