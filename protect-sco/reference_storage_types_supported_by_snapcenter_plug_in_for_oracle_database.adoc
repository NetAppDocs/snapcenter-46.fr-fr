...
|===
Le https://imt.netapp.com/matrix/imt.jsp?components=103047;&solution=1257&isHWU&src=IMT["Matrice d'interopérabilité NetApp"] contient les dernières informations sur les versions prises en charge.
