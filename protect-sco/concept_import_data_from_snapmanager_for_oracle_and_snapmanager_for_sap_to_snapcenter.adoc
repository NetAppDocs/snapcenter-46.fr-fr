...
Les configurations prises en charge par le plug-in SnapCenter pour base de données Oracle sont répertoriées dans le https://imt.netapp.com/matrix/imt.jsp?components=103047;&solution=1257&isHWU&src=IMT["Matrice d'interopérabilité NetApp"^].
